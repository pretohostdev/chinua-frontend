            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div className="flex   gap-3 items-center justify-end  flex-row  mt-4 px-2">
                        ...
                        <button className="bg-yellow-500 hover:border-[1px] hover:bg-yellow-800  text-white font-bold py-2 px-4 rounded" onClick={() => handleLimitChange(data?.length)}>Todas as Terras</button>
                    ...
                    <div style={{
...

                        {
                            ...
                            data?.slice(0, quantidadeExibida).map((produdo, index) => (
                        ...
                        {
                            isLoading && (
                                <div className="w-full h-screen  bg-yellow-400 mt-8 rounded  mx-5  flex  justify-center items-center"   >
                                   <Spinner/>
                                </div>
                            )
                        }
